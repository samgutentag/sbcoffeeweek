...
const restaurants = [
  ...
  // --- Dune Coffee (4 locations) ---
  {
    ...
    appleMapsUrl: "https://maps.apple/p/tNnJ9W5d1q~8wE",
    justCoffee: true,
    coffeeWithFood: false,
    coffeeAsCocktail: false,
    menuItems: [
  ...
  },
  {
    ...
    appleMapsUrl: "https://maps.apple/p/awKaRJEIj4DbQo",
    justCoffee: true,
    coffeeWithFood: false,
    coffeeAsCocktail: false,
    menuItems: [
  ...
  },
  {
    ...
    appleMapsUrl: "https://maps.apple/p/xLfeexdIXfx7jH",
    justCoffee: true,
    coffeeWithFood: false,
    coffeeAsCocktail: false,
    menuItems: [
  ...
  },
  {
    ...
    appleMapsUrl: "https://maps.apple/p/KrI96k-h7oVcXW",
    justCoffee: true,
    coffeeWithFood: false,
    coffeeAsCocktail: false,
    menuItems: [
  ...
  // --- Carpinteria ---
  {
    ...
    appleMapsUrl: "https://maps.apple/p/NJtuNiw7Uf4gYy",
    justCoffee: true,
    coffeeWithFood: false,
    coffeeAsCocktail: false,
    menuItems: [
  ...
  // --- Downtown ---
  {
    ...
    appleMapsUrl: "https://maps.apple/p/eX4m6Sd3jR1ZZx",
    justCoffee: true,
    coffeeWithFood: false,
    coffeeAsCocktail: false,
    menuItems: [
  ...
  // --- Downtown ---
  {
    ...
    appleMapsUrl: "https://maps.apple/p/9j2N9nG.wLDQk2",
    justCoffee: false,
    coffeeWithFood: true,
    coffeeAsCocktail: false,
    menuItems: [
  ...
  // --- Renaud's Patisserie (4 locations) ---
  {
    ...
    appleMapsUrl: "https://maps.apple/p/LZaE2d8~ByEzDv",
    justCoffee: false,
    coffeeWithFood: true,
    coffeeAsCocktail: false,
    menuItems: [
  ...
  },
  {
    ...
    appleMapsUrl: "https://maps.apple/p/LHSXr2vzGi2cQC",
    justCoffee: false,
    coffeeWithFood: true,
    coffeeAsCocktail: false,
    menuItems: [
  ...
  },
  {
    ...
    appleMapsUrl: "https://maps.apple/p/fBFnpNe7BzksuE",
    justCoffee: false,
    coffeeWithFood: true,
    coffeeAsCocktail: false,
    menuItems: [
  ...
  // --- Goleta ---
  {
    ...
    appleMapsUrl: "https://maps.apple/p/KbZcG_MobzFMzH",
    justCoffee: false,
    coffeeWithFood: false,
    coffeeAsCocktail: true,
    menuItems: [
  ...
  // --- Downtown ---
  {
    ...
    appleMapsUrl: "https://maps.apple/p/IZz6.kmGN4tvm.z",
    justCoffee: false,
    coffeeWithFood: false,
    coffeeAsCocktail: true,
    menuItems: [
  ...
  // --- Downtown ---
  {
    ...
    appleMapsUrl: "https://maps.apple/p/tegWjmFQI6WW~Y",
    justCoffee: false,
    coffeeWithFood: false,
    coffeeAsCocktail: true,
    menuItems: [
